...
public class ZipkinBean {
    ...
    public SpanCollector spanCollector() {
        ...
        return HttpSpanCollector.create("http://10.19.115.202:9411", config, new EmptySpanCollectorMetricsHandler());
    }
    ...
    public Brave brave(SpanCollector spanCollector) {
        Builder builder = new Builder("demo-client");// 指定serviceName
